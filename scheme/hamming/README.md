...
Welcome to Hamming on Exercism's Scheme Track.
...
The failing input is presented as a list because the tests call your solution by `(apply hamming input-list)`\.
